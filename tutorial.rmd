...
```
#Bash Shell
Rscript bacterialGWAS/kmerGWAS/kmerLMM.R -chisqStat fus300.gwaskmer-out.chisqStat.txt -patternKey fus300.gwaskmer-out.patternKey.txt -patternIndex fus300.gwaskmer-out.patternIndex.txt  -signif 5000 -relateMatrix ~/data/fus300_gemma_relmatrixout.cXX.txt -phenotype fus300_gemma_phenotype.txt -prefix fus300 -externalSoftware dependencies.txt
```
